...
?>
			...
			<div class="card-body">
				...
				<div class="payment-info flex justify-space-between">
					...
					<div class="column shipping">
						<div class="title">
							<div class="num">2</div>
							<h4>Informações da conta do Paypal</h4>
						</div>
						<div class="field full">
						...
						<div class="field full">
							<label for="address">Numero da conta</label>
						...
						<div class="field full">
							<label for="zip">Código de segurança</label>
							<input id="zip" type="text" placeholder="468382910">
						</div>
					</div>
				</div>
			</div>
			<div class="card-actions flex justify-space-between">
				...
				<div class="flex-end">
					<a href="" class="links"><button class="button button-primary">Prosseguir</button></a>
				</div>
			</div>
		</div>
	</article>
